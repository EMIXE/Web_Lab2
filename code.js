...
function squareSplit() {
    ...
    const
        ...
        semiColor = "hsl(" + hue.toString() + ", " + (saturation - saturation/level + amort).toString() + "%, " + (lightness - lightness/level).toString() + "%)",
...
function loose() {
    ...
    alert(`you died. you have reached ${level.toString()} level.`);
